...
import { AtalayaDemoCard } from '../atalaya/atalaya-demo-card';
  ...
  return (
    <Container style={{ paddingVertical: 56 }} nativeID="projects">
      ...
      <View style={[{ flexDirection: 'row', flexWrap: 'wrap', gap: 16 }, gridWeb as object]}>
        ...
        <Reveal delay={350} style={{ flexGrow: 1, flexBasis: 340, minWidth: 300 }}>
          <AtalayaDemoCard />
        </Reveal>
        {projects.items.map((item, i) => (
          <Reveal key={item.title} delay={(i + 6) * 70} style={{ flexGrow: 1, flexBasis: 340, minWidth: 300 }}>
