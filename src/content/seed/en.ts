...
export const en: PortfolioContent = {
  nav: {
    ...
    dock: { home: 'Home', services: 'Services', about: 'About', projects: 'Projects', contact: 'Contact', blog: 'Blog' },
  },
  hero: {
  ...
  testimonials: {
    ...
    items: [
      { name: 'Juan Cruz Cuello', photoUrl: '/images/testimonials/juan-cruz-cuello.jpg', role: 'SSR Software Engineer · NaranjaX', quote: 'Luis is an excellent professional and teammate. When we stopped sharing a team, I looked back very pleased with how much he had grown as an engineer and how much I had learned from him. I certainly hope we cross paths again in the future.' },
      { name: 'Roberth Borges', photoUrl: '/images/testimonials/roberth-borges.jpg', role: 'Engineering Manager · Tech Lead', quote: "I had the opportunity to work with Luis for a couple of years. He is an extremely proactive person, committed to reaching the team's goals, and always brings an excellent attitude and positive energy that add a lot of value to a great work environment. Luis is technically very solid, with strong experience in JavaScript, microservices and event-driven architectures." },
      { name: 'Manuel Yaffe', photoUrl: '/images/testimonials/manuel-yaffe.jpg', role: 'Project Management · Cencosud', quote: 'I had the pleasure of working with Luis at Cencosud and I was always impressed by his technical skill and his ability to research complex solutions. His command of diverse technologies allows him to deliver high-quality results within tight deadlines. He is also an excellent collaborator, always willing to help and share knowledge with the team.' },
      { name: 'Jorge Ramírez', photoUrl: '/images/testimonials/jorge-ramirez.jpg', role: 'Head of Product · Digital Banking', quote: "I had the opportunity to work with Luis on the Regional Home Delivery project, where he was key to integrating the product with the billing ecosystem. Luis stood out for his high technical level, problem-solving focus and excellent teamwork. His contribution was decisive for the project's success." },
      { name: 'Gerardo Alvarez Muñoz', photoUrl: '/images/testimonials/gerardo-alvarez-munoz.jpg', role: 'Staff Engineer', quote: 'I am happy to recommend Luis Alberto for any developer position. I have had the pleasure of working with him on several projects. I can attest to his technical and professional skills, as well as his problem-solving, excellent teamwork, and adaptability, and he would be a valuable addition to any development team.' },
      { name: 'Andrés Juárez', photoUrl: '/images/testimonials/andres-juarez.jpg', role: 'Tech Lead · Software Architecture', quote: 'Luis is a developer with standout adaptability; he works very well in a team, has excellent technical skills and is deeply committed to his work. I recommend working with him for all these professional qualities and the many personal qualities he has.' },
      ...
      { name: 'Tom Baran-Martinez', photoUrl: '/images/testimonials/tom-baran-martinez.jpg', role: 'English Speaking Coach', quote: "I had the pleasure and honor of being Luis's English Speaking Coach for 4 months. During that time, Luis worked hard to obtain a new job with Acid Labs, where he had to (and continues to) speak English regularly with his team and clients. In my program, Luis always treated me, my staff, and his peers with the utmost respect." },
      { name: 'John Jiménez', photoUrl: '/images/testimonials/john-jimenez.jpg', role: 'Digital Marketing Strategist', quote: 'He is an excellent professional; I highlight his responsibility and commitment to every one of his activities. He knows how to work in a team, with very good methodologies that make it easier to meet goals.' },
      { name: 'Edgar Quiles', photoUrl: '/images/testimonials/edgar-quiles.jpg', role: 'Director of Sales · BeTrep', quote: 'Alberto, who was part of our institution for a year, is a person of impeccable integrity. He has proven to be an excellent asset to any team he joins: his work always stands out among the best and he faces challenges in a committed, responsible and organized way. Above all, he has an entrepreneurial attitude, always seeking growth and improvement for everyone.' },
      { name: 'Andres Diaz', photoUrl: '/images/testimonials/andres-diaz.jpg', role: 'Flutter Developer · Founder of Jobnow', quote: 'An excellent professional and person, with an enormous capacity to learn and remarkably broad knowledge of technology.' },
      { name: 'Mauricio Baena Vásquez', photoUrl: '/images/testimonials/mauricio-baena-vasquez.jpg', role: 'Senior Graphic Designer', quote: 'A great team member, passionate about his career, proactive and responsible; he is also a good teammate, works well in a team and is very supportive.' },
    ],
  },
  certifications: {
